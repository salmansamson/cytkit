...
![](images/build diagrams/base to stand perspective from bottom.png)
![](images/build diagrams/base to stand orthographic from bottom.png)
![](images/build photos/20260530_121708 base to stand.jpg)

## Attach main body to base, with springs under adjustment arms {pagestep}
...
*** image of standing springs

![](images/build diagrams/springs in base.png)

Carefully lower the main body onto the base as shown so that the circular cavities under the adjustment arms capture the top of the springs without knocking them over. Then screw the main body to the base with 9 x [M3 self-tapping posi head screws 12 mm](mechanical/screws.yaml#self_tapping_m3x12_posi){qty:9, cat:mechanics}. 
...
Working underneath the instrument, you may lay the instrument on its side again if you find it easier. The fluidics cart is attached to the stand with 4 x [M3 self-tapping posi head screws 8 mm](mechanical/screws.yaml#self_tapping_m3x8_posi){qty:4, cat:mechanics}. 

![](images/build photos/20260530_123901 fluidics cart attachment.jpg)
![](images/build diagrams/fluidics cart attachment.png)
